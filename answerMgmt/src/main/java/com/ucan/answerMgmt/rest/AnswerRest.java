...
public class AnswerRest {
	...
	public @ResponseBody Answer getAnswer(@PathVariable("id") long id) {
	...
	@RequestMapping(value=URLConstants.POST_ANSWER_URL,method=RequestMethod.POST)
	public void createAnswer(@RequestBody Answer a) {
		System.out.println("in post answer rest");
		 answerServe.createaAnswer(a);
		 }
	...
	public @ResponseBody List<Answer> getSessionAnswers(@PathVariable("dsid") long sid) {
